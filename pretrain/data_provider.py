...
class Data_Form:
    ...
    def _run(self, flnm: str, cols: object):
        ...
        f_data = open("./data/train/data_600m_interval%d_len%d.bin"%(self.interval, self.LEN), 'ab+')
        f_index = open("./data/train/index_600m_interval%d_len%d.bin"%(self.interval, self.LEN), 'ab+')
