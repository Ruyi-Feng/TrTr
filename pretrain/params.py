...
def params():
    ...
    parser.add_argument('--index_path', type=str, default='./data/train/index_interval6_len30.bin')
    parser.add_argument('--data_path', type=str, default='./data/train/data_interval6_len30_val.bin')
